...
const Terms = () => {
  return (
    <>
      <section className="mtop flex_space terms">
        <div className="container">
          <p className="mb-5" style={{ textAlign: "justify" }}>
            This website is operated by kasutam(kasutam International).
            Throughout the site, the terms “we”, “us” and “our” refer to
            kasutam(kasutam International). kasutam(kasutam international)
            ...
            of those changes. Our store is hosted on amazon web service. They
            provide us with the online e-commerce platform that allows us to
          ...
          <div className="mb-5">
            ...
            <p style={{ textAlign: "justify" }}>
              ...
              case shall kasutam, our directors, officers, employees,
          ...
          <div className="mb-5">
            ...
            <p style={{ textAlign: "justify" }}>
              You agree to indemnify, defend and hold harmless kasutam and our
          ...
          <div className="mb-5">
            ...
            <p style={{ textAlign: "justify" }}>
            Questions about the Terms of Service should be sent to us at info@kasutam.com .
            </p>
          </div>
        </div>
      </section>
