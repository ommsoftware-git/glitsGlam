...
const Privacy = () => {
  return (
    <>
      <section className="mtop flex_space privacy">
        <div className="container">
          ...
          <div className="mb-5">
            <h5 className="mb-4">SECTION 2 - CONSENT</h5>
            ...
            <p style={{ textAlign: "justify" }}>
              ...
              info@kasutam.com or mailing us at:- kasutam international , ward
              no-4, asalwas road, village- asalwas, surajgarh, jhunjhunu,
              rajasthan, 333033
            </p>
          </div>
          <div className="mb-5">
            <h5 className="mb-4">SECTION 3 - DISCLOSURE</h5>
          ...
          <div className="mb-5">
            <h5 className="mb-4">SECTION 4 - Aws(amazon web service)</h5>

            <p style={{ textAlign: "justify" }}>
              Our store is hosted on aws(amazon web service) Inc. They provide
              us with the online e-commerce platform that allows us to sell our
              products and services to you. Your data is stored through amazon
              web service data storage, databases and the general Shopify
              application. They store your data on a secure server behind a
              firewall.
            </p>
            <h6>Payment:</h6>
            <p style={{ textAlign: "justify" }}>
              If you choose a direct payment gateway to complete your purchase,
              then instamojo your credit card data. It is encrypted through the
              Payment Card Industry Data Security Standard (PCI-DSS). Your
              ...
              your purchase transaction information is deleted. All direct
              payment gateways adhere to the standards set by PCI-DSS as managed
              ...
              insight, you may also want to read insatamojo Privacy Statement
              (https://www.instamojo.com/company/privacy/) or Terms of Service
              (https://www.instamojo.com/company/terms/).
            </p>
          </div>
          <div className="mb-5">
            <h5 className="mb-4">SECTION 5 - THIRD-PARTY SERVICES</h5>
          ...
          <div className="mb-5">
            <h5 className="mb-4">SECTION 6 - SECURITY</h5>
          ...
          <div className="mb-5">
            <h5 className="mb-4">SECTION 7 - COOKIES</h5>
            ...
            <p style={{ textAlign: "justify" }}>
              _session_id, unique token, sessional, Allows instamojo to store
              information about your session (referrer, landing page, etc).
            </p>
            <p style={{ textAlign: "justify" }}>
              _instamojo_visit, no data held, Persistent for 30 minutes from the
            ...
            <p style={{ textAlign: "justify" }}>
              When you logout from our website we deleted your uniqe tocken and
              session id from our browser.
            </p>
          </div>
          <div className="mb-5">
            <h5 className="mb-4">SECTION 8 - AGE OF CONSENT</h5>
          ...
          <div className="mb-5">
            <h5 className="mb-4">SECTION 9 - CHANGES TO THIS PRIVACY POLICY</h5>
          ...
          <div className="mb-5">
            <h5 className="mb-4">QUESTIONS AND CONTACT INFORMATION</h5>
            ...
            <p style={{ textAlign: "justify" }}>
              ...
              Officer at info@kasutam.com or by mail at:-
            </p>
          </div>
        </div>
      </section>
